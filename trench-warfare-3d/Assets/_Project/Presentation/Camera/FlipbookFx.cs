...
namespace TW.Presentation.Tactical
{
    public sealed class FlipbookFx
    {
        ...
        static readonly Sheet[] Sheets =
        {
            ...
            new Sheet { Name = "FireBlast", Cols = 8, Rows = 4, Frames = 17, Fire = true, Snap = true, Tint = new Color(1.40f, 0.66f, 0.20f), Low = 0.09f, High = 0.86f, Fps = 12f, Rise = 0.45f, Bands = new Vector4(0.05f, 0.11f, 0.70f, 0.75f), Ink = new Vector2(0.12f, 0.87f), Fill = 0.90f },
