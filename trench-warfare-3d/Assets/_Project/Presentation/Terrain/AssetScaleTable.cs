...
namespace TW.Presentation.Terrain
{
    ...
    public static class AssetScaleTable
    {
        ...
        static Dictionary<string, ScaleRule> Build()
        {
            ...
            S("kit/shellCases", ScaleAxis.Length, 0.26f, 0.45f, "three spent cases lying together: the group is two thirds of a metre across (the debris step's 0.85-1.35 fits)");
            S("kit/helmet", ScaleAxis.Length, 0.13f, 0.18f, "a helmet fits a head");
            S("kit/boots", ScaleAxis.Length, 0.20f, 0.32f, "a pair laid out, one on its side: half a metre across (the camp's jitter fits)");
            S("kit/ammoTin", ScaleAxis.Length, 0.22f, 0.35f, "an open tin with its rounds spilled beside it (the camp's jitter fits)");
            S("kit/messKit", ScaleAxis.Height, 0.04f, 0.08f, "a mess tin a hand high, the bottle lying beside it");
            ...
            S("kit/spade", ScaleAxis.Height, 0.25f, 0.48f, "an entrenching tool (built 0.80 m tall; the camp's jitter fits)");
