...
// (streaks fade out toward the box's faces, close to the lens and far away). Additive, so it only ever adds a little
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings vert(Attributes v)
            {
                ...
                float3 p = v.positionOS.xyz * _Size.xyz + velocity * _Time.y;
