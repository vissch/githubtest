...
// select; CAMPAIGN waits for the A7 campaign map; SETTINGS and QUIT do what they say.
using UnityEngine;
...
namespace TW.UI
{
    ...
    {
        public static readonly string[] RequiredNames = { "backdrop", "title", "subtitle", "menu-stack", "btn-skirmish", "btn-campaign", "btn-settings", "btn-quit", "version" };
