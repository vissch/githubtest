...
> **Historical, archived 2026-09-25.** The state of the work as handed over on 2026-09-22. It is not maintained.
> Start from `CLAUDE.md`; current status is in `docs/README.md` and decisions in `docs/reference/decisions.md`.
> The next-agent prompt that closed this file was removed: it pointed at milestones long since passed.
