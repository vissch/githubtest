...
| Mines and tripwires (implemented, docs/21 SIM-D; laid by the sapper once units-meta lands, a system call until then) | 1 charge | — | 1 s (arming) | Point / line up to 12 m | A mine: 260 dmg r 4 m, +50, crater 1.5 m, goes off under an enemy man within 1 m or anywhere under an enemy hull's footprint (the nearer track takes it); a tripwire: 90 dmg r 4.5 m, +40, crossed within 0.6 m; a shell's crater cooks off the mines within 1.5 x its radius | Shell the ground ahead; keep to the trenches (a mine never lies in one, though a tripwire may hug a trench's lip) |
