...
| Heightfield line-of-sight raycast, target acquisition (staggered, coarse grid, over-the-parapet LoS), direct fire with cover / stance / range, near-miss suppression, prone / pinned / fire-step, deaths, sector control (objective order, trench ownership, HQ ends the match) | Unit-level indirect fire, burning, armour penetration, smoke, mustard gas |
...
| Off-map support: HE barrage and chlorine gas (`OffMapAbilitySystem`), blast with trench / crater / prone protection, crater stamps that deform the heightfield and nav layers, wind-driven gas field that pools in trenches and drives garrisons out | Creeping barrage, bomber, smoke screen, mortar, recon, surge; wire and mud |
